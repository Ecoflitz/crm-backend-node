...
module.exports = class CategoriesDBApi {
  static async create(data, options) {
    ...
    await categories.setOrganizations(data.organizations || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.leads_category = await categories.getLeads_category({
      transaction,
    });

    output.organizations = await categories.getOrganizations({
      transaction,
    });
