...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.activities_organizations =
      await organizations.getActivities_organizations({
        transaction,
      });
    ...
    output.contacts_organizations =
      await organizations.getContacts_organizations({
        transaction,
      });
    ...
    output.notes_organizations = await organizations.getNotes_organizations({
      transaction,
    });
